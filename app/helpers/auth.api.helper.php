...
class AuthHelper{
    ...
    function getAuthHeaders(){
        ...
        return $header; //sino se cumple ningun if devuelve vacio
    }
    ...
    function createToken($payload){
        ...
        $signature = hash_hmac('SHA256', "$header.$payload", JWT_KEY, true); //crea firma.
        $signature = base64url_encode($signature); //codifica firma.
    ...
    function currentUser(){
        ...
        return $this->verify($auth[1]); //si esta bien devuelve el payload
    }
}